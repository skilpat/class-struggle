...
-- Most downloaded packages from Hackage on 2015.05.13
-- Only those above 1000 downloads
-- https://hackage.haskell.org/packages/top
hackageMostDownloadedPkgs = [ "lens"
                            , "warp"
                            , "text"
                            , "attoparsec"
                            , "Cabal"
...
-- stackage 1.4
-- http://www.stackage.org/snapshot/lts-1.4/cabal.config

stackagePkgs = map (takeWhile (/= ' ')) stackagePkgConstraints
stackagePkgConstraints = [ "abstract-deque ==0.3"
                         , "abstract-par ==0.3.3"
                         , "accelerate ==0.15.0.0"
                         , "ace ==0.6"
