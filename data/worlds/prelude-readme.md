...
* Calculated using the Cabalized package at https://github.com/skilpat/class-struggle
...
<module-name> -> { <module-name-defining-instances> (<number-instances-there>)
                   ... } (<number-instances-here> ; <consistency>)
```
...
containers-0.5.5.1:Data.Map -> {containers-0.5.5.1:Data.Map.Base (11), 
                                ...
                                base:Data.Ord (4)}
                               (1621 ; consistent)
base => consistent (1675)
containers-0.5.5.1 => consistent (1759)
```
